...
class Cl_score:
    ...
    def cl_score(self,allcl):
        ...
        #---------------------------------------------------百融策略规则---------------------------------------------------#
            #---------------------------------------------------百融策略规则---------------------------------------------------#
        if  allcl['ir_m6_cell_x_tel_home_cnt'] >= 4.0  or  allcl['ir_m6_cell_x_biz_addr_cnt'] >= 4.0  or  allcl['ir_m6_cell_x_home_addr_cnt'] >= 4.0  or  allcl['ir_m6_cell_x_id_cnt'] >= 3.0  or  allcl['ir_m6_cell_x_mail_cnt'] >= 4.0  :
            dict_stratege_child['BR0001'] = 75
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0001'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m12_cell_max_monnum'] >= 17.0  or  allcl['als_m12_id_max_monnum'] >= 17.0  :
            dict_stratege_child['BR0002'] = 73
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0002'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m1_cell_caon_allnum'] >= 5.0  or  allcl['als_m1_id_caon_allnum'] >= 5.0  :
            dict_stratege_child['BR0003'] = 73
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0003'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m12_id_max_monnum'] >= 13.0   or  allcl['als_m12_cell_max_monnum'] >= 13.0   :
            dict_stratege_child['BR0004'] = 73
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0004'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m1_cell_nbank_week_allnum'] >= 4.0  or  allcl['als_m12_cell_nbank_week_allnum'] >= 11.0  or  allcl['als_m1_id_nbank_week_allnum'] >= 4.0  or  allcl['als_m12_id_nbank_week_allnum'] >= 11.0  :
            dict_stratege_child['BR0005'] = 72
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0005'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m1_cell_caon_allnum'] >= 3.0   or  allcl['als_m1_id_caon_allnum'] >= 3.0   :
            dict_stratege_child['BR0006'] = 72
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0006'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  (allcl['ex_bad1_name'] !="" and  allcl['ex_bad1_performance'] != "失信记录已退出")  or (allcl['ex_bad2_name'] != "" and  allcl['ex_bad2_performance'] !="失信记录已退出")  or \
            (allcl['ex_bad3_name'] !="" and  allcl['ex_bad3_performance'] != "失信记录已退出")  or (allcl['ex_bad4_name'] != "" and  allcl['ex_bad4_performance'] !="失信记录已退出")  or  \
            (allcl['ex_bad5_name'] !="" and  allcl['ex_bad5_performance'] == "失信记录已退出")  or (allcl['ex_bad6_name'] != "" and  allcl['ex_bad6_performance'] == "失信记录已退出")  or  \
            (allcl['ex_bad7_name'] !="" and  allcl['ex_bad7_performance'] == "失信记录已退出")  or (allcl['ex_bad8_name'] != "" and  allcl['ex_bad8_performance'] == "失信记录已退出")  or \
            (allcl['ex_bad9_name'] !="" and  allcl['ex_bad9_performance'] == "失信记录已退出")  or (allcl['ex_bad10_name'] != "" and  allcl['ex_bad10_performance'] == "失信记录已退出")  :
            dict_stratege_child['BR0007'] = 71
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0007'] = 0
            dict_strategy_group.update(dict_stratege_child)
        print('sum',sum([allcl['als_m6_nsloan_count'],allcl['als_m6_cons_count'], allcl['als_m6_autofin_count'], allcl['als_m6_sloan_count'],allcl['als_m6_finlea_count'], allcl['als_m6_else_count']]))
        if  sum([allcl['als_m6_nsloan_count'],allcl['als_m6_cons_count'], allcl['als_m6_autofin_count'], allcl['als_m6_sloan_count'],allcl['als_m6_finlea_count'], allcl['als_m6_else_count']]) >= 5.0  or \
            sum([allcl['als_m12_nsloan_count'],allcl['als_m12_cons_count'], allcl['als_m12_autofin_count'], allcl['als_m12_sloan_count'],allcl['als_m12_finlea_count'], allcl['als_m12_else_count']]) >= 6.0  :
            dict_stratege_child['BR0008'] = 71
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0008'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['alm_d7_cell_nbank_else_allnum'] >= 2.0  or  allcl['alm_d15_cell_nbank_allnum'] >= 5.0  or  allcl['als_m1_cell_nbank_else_allnum'] >= 6.0  or \
            allcl['alm_d7_id_nbank_else_allnum'] >= 2.0  or  allcl['alm_d15_id_nbank_allnum'] >= 5.0  or  allcl['als_m1_id_nbank_else_allnum'] >= 6.0  :
            dict_stratege_child['BR0009'] = 71
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0009'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m1_cell_pdl_allnum'] >= 4.0  or  allcl['als_m3_cell_pdl_allnum'] >= 10.0  or  allcl['als_m1_id_pdl_allnum'] >= 4.0  or  allcl['als_m3_id_pdl_allnum'] >= 10.0  :
            dict_stratege_child['BR0010'] = 71
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0010'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  sum([allcl['als_m6_rel_count'], allcl['als_m6_pdl_count'], allcl['als_m6_caon_count'], allcl['als_m6_caoff_count'],allcl['als_m6_coon_count'], allcl['als_m6_cooff_count'], allcl['als_m6_af_count'], allcl['als_m6_oth_count']]) >= 6.0 or \
            sum([allcl['als_m12_rel_count'], allcl['als_m12_pdl_count'], allcl['als_m12_caon_count'], allcl['als_m12_caoff_count'], allcl['als_m12_coon_count'], allcl['als_m12_cooff_count'], allcl['als_m12_af_count'], allcl['als_m12_oth_count']]) >= 7.0  :
            dict_stratege_child['BR0011'] = 70
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0011'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m1_cell_caon_allnum'] >= 2.0   or allcl['als_m1_id_caon_allnum'] >= 2.0   :
            dict_stratege_child['BR0012'] = 70
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0012'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  sum([allcl['als_m1_rel_count'], allcl['als_m1_pdl_count'], allcl['als_m1_caon_count'], allcl['als_m1_caoff_count'],allcl['als_m1_coon_count'], allcl['als_m1_cooff_count'], allcl['als_m1_af_count'], allcl['als_m1_oth_count']] )>= 4.0  or \
            sum([allcl['als_m3_rel_count'], allcl['als_m3_pdl_count'], allcl['als_m3_caon_count'], allcl['als_m3_caoff_count'],allcl['als_m3_coon_count'], allcl['als_m3_cooff_count'], allcl['als_m3_af_count'], allcl['als_m3_oth_count']] )>= 5.0  :
            dict_stratege_child['BR0013'] = 70
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0013'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m12_cell_nbank_allnum'] >= 29.0  or  allcl['als_m12_cell_nbank_else_allnum'] >= 23.0  or  allcl['als_m12_id_nbank_allnum'] >= 29.0  or  allcl['als_m12_id_nbank_else_allnum'] >= 23.0  :
            dict_stratege_child['BR0014'] = 70
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0014'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m1_id_pdl_allnum'] >= 3.0 or allcl['als_m3_cell_pdl_allnum'] >= 7.0  or  allcl['als_m3_id_pdl_allnum'] >= 7.0   :
            dict_stratege_child['BR0015'] = 70
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0015'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m12_cell_oth_allnum'] >= 4.0  or  allcl['als_m12_id_oth_allnum'] >= 4.0  :
            dict_stratege_child['BR0016'] = 70
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0016'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m12_cell_pdl_allnum'] >= 17.0  or  allcl['als_m12_id_pdl_allnum'] >= 17.0  :
            dict_stratege_child['BR0017'] = 70
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0017'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  sum([allcl['als_m1_nsloan_count'], allcl['als_m1_cons_count'], allcl['als_m1_autofin_count'], allcl['als_m1_sloan_count'],allcl['als_m1_finlea_count'], allcl['als_m1_else_count']] )>= 4.0  :
            dict_stratege_child['BR0018'] = 70
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0018'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m6_cell_caon_allnum'] >= 6.0  or  allcl['als_m6_id_caon_allnum'] >= 6.0  or  allcl['als_m12_cell_caon_allnum'] >= 8.0  or  allcl['als_m12_id_caon_allnum'] >= 8.0  :
            dict_stratege_child['BR0019'] = 70
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0019'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m1_id_nbank_week_allnum'] >= 3.0  or  allcl['als_m1_cell_nbank_week_allnum'] >= 3.0  or  allcl['als_m12_cell_nbank_week_allnum'] >= 8.0   or  allcl['als_m12_id_nbank_week_allnum'] >= 8.0   :
            dict_stratege_child['BR0020'] = 70
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0020'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m12_cell_nbank_night_orgnum'] >= 3.0  or  allcl['als_m12_id_nbank_night_orgnum'] >= 3.0  :
            dict_stratege_child['BR0021'] = 70
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0021'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  sum([allcl['als_m1_nsloan_count'], allcl['als_m1_cons_count'], allcl['als_m1_autofin_count'], allcl['als_m1_sloan_count'],allcl['als_m1_finlea_count'], allcl['als_m1_else_count']]) >= 3.0   :
            dict_stratege_child['BR0022'] = 69
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0022'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m12_cell_nbank_allnum'] >= 21.0   or  allcl['als_m12_id_nbank_allnum'] >= 21.0  or  allcl['als_m12_cell_nbank_else_allnum'] >= 15.0   or  allcl['als_m12_id_nbank_else_allnum'] >= 15.0   :
            dict_stratege_child['BR0023'] = 69
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0023'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m12_id_oth_allnum'] >= 3.0   or  allcl['als_m12_cell_oth_allnum'] >= 3.0  :
            dict_stratege_child['BR0024'] = 69
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0024'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m1_cell_nbank_else_allnum'] >= 2.0   or  allcl['als_m1_id_nbank_else_allnum'] >= 2.0  :
            dict_stratege_child['BR0025'] = 69
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0025'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m12_cell_pdl_allnum'] >= 12.0  or  allcl['als_m12_id_pdl_allnum'] >= 12.0   :
            dict_stratege_child['BR0026'] = 69
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0026'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  sum([allcl['als_m6_rel_count'], allcl['als_m6_pdl_count'], allcl['als_m6_caon_count'], allcl['als_m6_caoff_count'], allcl['als_m6_coon_count'], allcl['als_m6_cooff_count'], allcl['als_m6_af_count'], allcl['als_m6_oth_count']] )>= 5.0  or \
            sum([allcl['als_m12_rel_count'], allcl['als_m12_pdl_count'], allcl['als_m12_caon_count'], allcl['als_m12_caoff_count'], allcl['als_m12_coon_count'], allcl['als_m12_cooff_count'], allcl['als_m12_af_count'], allcl['als_m12_oth_count']] )>= 6.0  :
            dict_stratege_child['BR0027'] = 69
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0027'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m12_id_max_monnum'] >= 6.0  or  allcl['als_m12_cell_max_monnum'] >= 6.0   :
            dict_stratege_child['BR0028'] = 69
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0028'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m6_cell_caon_allnum'] >= 4.0  or  allcl['als_m6_id_caon_allnum'] >= 4.0  or allcl['als_m12_id_caon_allnum'] >= 5.0   or  allcl['als_m12_cell_caon_allnum'] >= 5.0   :
            dict_stratege_child['BR0029'] = 68
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0029'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m12_id_nbank_night_orgnum'] >= 2.0   or  allcl['als_m12_cell_nbank_night_orgnum'] >= 2.0   :
            dict_stratege_child['BR0030'] = 68
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0030'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m1_cell_pdl_allnum'] >= 2.0 or  allcl['als_m1_id_pdl_allnum'] >= 2.0   or  allcl['als_m3_id_pdl_allnum'] >= 4.0   or  allcl['als_m3_cell_pdl_allnum'] >= 4.0   :
            dict_stratege_child['BR0031'] = 68
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0031'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['sl_id_bad_info'] == 0.0  and  allcl['sl_id_bad_info_time'] <= 2.0  :
            dict_stratege_child['BR0032'] = 68
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0032'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  (allcl['ex_execut1_name'] !=""  and  allcl['ex_execut1_statute']!="已结案") or (allcl['ex_execut2_name'] !=""  and  allcl['ex_execut2_statute']!="已结案") or \
            (allcl['ex_execut3_name'] !=""  and  allcl['ex_execut3_statute']!="已结案") or (allcl['ex_execut4_name'] !=""  and  allcl['ex_execut4_statute']!="已结案") or \
            (allcl['ex_execut5_name'] !=""  and  allcl['ex_execut5_statute']!="已结案") or (allcl['ex_execut6_name'] !=""  and  allcl['ex_execut6_statute']!="已结案") or \
            (allcl['ex_execut7_name'] !=""  and  allcl['ex_execut7_statute']!="已结案") or (allcl['ex_execut8_name'] !=""  and  allcl['ex_execut8_statute']!="已结案") or \
            (allcl['ex_execut9_name'] !=""  and  allcl['ex_execut9_statute']!="已结案") or (allcl['ex_execut10_name'] !=""  and  allcl['ex_execut10_statute']!="已结案") :
            dict_stratege_child['BR0033'] = 68
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0033'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  sum([allcl['als_m1_rel_count'], allcl['als_m1_pdl_count'], allcl['als_m1_caon_count'], allcl['als_m1_caoff_count'],allcl['als_m1_coon_count'], allcl['als_m1_cooff_count'], allcl['als_m1_af_count'], allcl['als_m1_oth_count']] )>= 3.0 or \
            sum([allcl['als_m3_rel_count'], allcl['als_m3_pdl_count'], allcl['als_m3_caon_count'], allcl['als_m3_caoff_count'],allcl['als_m3_coon_count'], allcl['als_m3_cooff_count'], allcl['als_m3_af_count'], allcl['als_m3_oth_count']]) >= 4.0   :
            dict_stratege_child['BR0034'] = 68
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0034'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['ir_m6_id_x_biz_addr_cnt'] >= 4.0  or  allcl['ir_m6_id_x_home_addr_cnt'] >= 4.0  or  allcl['ir_m6_id_x_tel_home_cnt'] >= 4.0  or  allcl['ir_m6_id_x_cell_cnt'] >= 3.0  or  allcl['ir_m6_id_x_mail_cnt'] >= 4.0  :
            dict_stratege_child['BR0035'] = 68
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0035'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m1_id_nbank_week_allnum'] >= 2.0  or  allcl['als_m1_cell_nbank_week_allnum'] >= 2.0  or  allcl['als_m12_cell_nbank_week_allnum'] >= 5.0 or allcl['als_m12_id_nbank_week_allnum'] >= 5.0   :
            dict_stratege_child['BR0036'] = 68
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0036'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m12_cell_nbank_allnum'] >= 14.0   or  allcl['als_m12_id_nbank_allnum'] >= 14.0   or  allcl['als_m12_cell_nbank_else_allnum'] >= 7.0  or  allcl['als_m12_id_nbank_else_allnum'] >= 7.0   :
            dict_stratege_child['BR0037'] = 68
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0037'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['ir_m12_id_x_home_addr_cnt'] >= 7.0  or  allcl['ir_m12_id_x_tel_home_cnt'] >= 5.0  or  allcl['ir_m12_id_x_cell_cnt'] >= 4.0  or  allcl['ir_m12_id_x_mail_cnt'] >= 5.0  or \
            allcl['ir_m3_id_x_tel_home_cnt'] >= 4.0  or  allcl['ir_id_x_cell_cnt'] >= 5.0  or  allcl['ir_id_x_mail_cnt'] >= 5.0  :
            dict_stratege_child['BR0038'] = 68
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0038'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m12_id_oth_allnum'] >= 2.0   or  allcl['als_m12_cell_oth_allnum'] >= 2.0  :
            dict_stratege_child['BR0039'] = 67
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0039'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  sum([allcl['als_m6_nsloan_count'], allcl['als_m6_cons_count'], allcl['als_m6_autofin_count'], allcl['als_m6_sloan_count'],allcl['als_m6_finlea_count'], allcl['als_m6_else_count']] )>= 4.0   or \
            allcl['als_m12_organization_typeall'] >= 5.0  :
            dict_stratege_child['BR0040'] = 67
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0040'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m12_cell_pdl_allnum'] >= 7.0  or  allcl['als_m12_id_pdl_allnum'] >= 7.0  :
            dict_stratege_child['BR0041'] = 67
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0041'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m12_id_caon_allnum'] >= 3.0  or  allcl['als_m12_cell_caon_allnum'] >= 3.0   :
            dict_stratege_child['BR0042'] = 67
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0042'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['alm_d7_cell_nbank_else_allnum'] >= 1.0   or  allcl['alm_d7_id_nbank_else_allnum'] >= 1.0   or  allcl['alm_d15_cell_nbank_allnum'] >= 3.0   or \
            allcl['alm_d15_id_nbank_allnum'] >= 3.0   or  allcl['als_m1_cell_nbank_else_allnum'] >= 4.0  or  allcl['als_m1_id_nbank_else_allnum'] >= 4.0   :
            dict_stratege_child['BR0043'] = 67
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0043'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_d15_cell_cooff_allnum'] >= 1.0  or  allcl['als_d15_id_cooff_allnum'] >= 1.0  or  allcl['als_m12_id_cooff_orgnum'] >= 3.0  or  allcl['als_m12_cell_cooff_orgnum'] >= 3.0  :
            dict_stratege_child['BR0044'] = 67
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0044'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  sum([allcl['als_m6_rel_count'], allcl['als_m6_pdl_count'], allcl['als_m6_caon_count'], allcl['als_m6_caoff_count'], allcl['als_m6_coon_count'], allcl['als_m6_cooff_count'], allcl['als_m6_af_count'], allcl['als_m6_oth_count']] )>= 4.0   or \
            sum([allcl['als_m12_rel_count'], allcl['als_m12_pdl_count'], allcl['als_m12_caon_count'], allcl['als_m12_caoff_count'], allcl['als_m12_coon_count'], allcl['als_m12_cooff_count'], allcl['als_m12_af_count'], allcl['als_m12_oth_count']] )>= 5.0   :
            dict_stratege_child['BR0045'] = 67
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0045'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  sum([allcl['als_m1_nsloan_count'], allcl['als_m1_cons_count'], allcl['als_m1_autofin_count'], allcl['als_m1_sloan_count'],allcl['als_m1_finlea_count'], allcl['als_m1_else_count']]) >= 2.0 :
            dict_stratege_child['BR0046'] = 67
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0046'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m1_id_caon_allnum'] >= 1.0   or  allcl['als_m1_cell_caon_allnum'] >= 1.0   :
            dict_stratege_child['BR0047'] = 66
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0047'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m12_cell_cooff_orgnum'] >= 2.0   or  allcl['als_m12_id_cooff_orgnum'] >= 2.0   :
            dict_stratege_child['BR0048'] = 66
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0048'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  sum([allcl['als_m1_rel_count'], allcl['als_m1_pdl_count'], allcl['als_m1_caon_count'], allcl['als_m1_caoff_count'],allcl['als_m1_coon_count'], allcl['als_m1_cooff_count'], allcl['als_m1_af_count'], allcl['als_m1_oth_count']]) >= 2.0   or \
            sum([allcl['als_m3_rel_count'], allcl['als_m1_pdl_count'], allcl['als_m3_caon_count'], allcl['als_m3_caoff_count'],allcl['als_m3_coon_count'], allcl['als_m3_cooff_count'], allcl['als_m3_af_count'], allcl['als_m3_oth_count']]) >= 3.0  :
            dict_stratege_child['BR0049'] = 66
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0049'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  sum([allcl['als_m6_nsloan_count'], allcl['als_m6_cons_count'], allcl['als_m6_autofin_count'], allcl['als_m6_sloan_count'],allcl['als_m6_finlea_count'], allcl['als_m6_else_count']]) >= 3.0   or  \
            sum([allcl['als_m12_nsloan_count'], allcl['als_m12_cons_count'], allcl['als_m2_autofin_count'], allcl['als_m12_sloan_count'],allcl['als_m12_finlea_count'], allcl['als_m12_else_count']] )>= 4.0  :
            dict_stratege_child['BR0050'] = 65
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0050'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m1_cell_nbank_else_allnum'] >= 1.0 or  allcl['als_m1_id_nbank_else_allnum'] >= 1.0   :
            dict_stratege_child['BR0051'] = 65
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0051'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m12_id_oth_allnum'] >= 1.0   or  allcl['als_m12_cell_oth_allnum'] >= 1.0   :
            dict_stratege_child['BR0052'] = 65
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0052'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  sum([allcl['als_m6_rel_count'], allcl['als_m6_pdl_count'], allcl['als_m6_caon_count'], allcl['als_m6_caoff_count'], allcl['als_m6_coon_count'], allcl['als_m6_cooff_count'], allcl['als_m6_af_count'], allcl['als_m6_oth_count']]) >= 3.0  or \
            sum([allcl['als_m12_rel_count'], allcl['als_m12_pdl_count'], allcl['als_m12_caon_count'], allcl['als_m12_caoff_count'], allcl['als_m12_coon_count'], allcl['als_m12_cooff_count'], allcl['als_m12_af_count'], allcl['als_m6_oth_count']])>= 4.0 :

            dict_stratege_child['BR0053'] = 65
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0053'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m12_cell_pdl_allnum'] >= 3.0 or  allcl['als_m12_id_pdl_allnum'] >= 3.0   :
            dict_stratege_child['BR0054'] = 64
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0054'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['ald_cell_nbank_allnum'] >= 5.0  or  allcl['ald_id_nbank_allnum'] >= 5.0  :
            dict_stratege_child['BR0055'] = 64
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0055'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m12_id_nbank_night_orgnum'] >= 1.0   or  allcl['als_m12_cell_nbank_night_orgnum'] >= 1.0   :
            dict_stratege_child['BR0056'] = 64
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0056'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m1_id_nbank_week_allnum'] >= 1.0   or  allcl['als_m1_cell_nbank_week_allnum'] >= 1.0  or  allcl['als_m12_cell_nbank_week_allnum'] >= 2.0  or  allcl['als_m12_id_nbank_week_allnum'] >= 2.0   :
            dict_stratege_child['BR0057'] = 63
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0057'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m3_id_pdl_allnum'] >= 1.0   or  allcl['als_m3_cell_pdl_allnum'] >= 1.0   :
            dict_stratege_child['BR0058'] = 63
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0058'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  sum([allcl['als_m6_nsloan_count'], allcl['als_m6_cons_count'], allcl['als_m6_autofin_count'], allcl['als_m6_sloan_count'],allcl['als_m6_finlea_count'], allcl['als_m6_else_count']])>= 2.0   or \
            sum([allcl['als_m12_nsloan_count'], allcl['als_m12_cons_count'], allcl['als_m12_autofin_count'], allcl['als_m12_sloan_count'],allcl['als_m12_finlea_count'], allcl['als_m12_else_count']]) >= 3.0   :
            dict_stratege_child['BR0059'] = 63
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0059'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  sum([allcl['als_m1_nsloan_count'], allcl['als_m1_cons_count'], allcl['als_m1_autofin_count'], allcl['als_m1_sloan_count'],allcl['als_m1_finlea_count'], allcl['als_m1_else_count'] ] )>= 1.0 :
            dict_stratege_child['BR0060'] = 63
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0060'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m12_cell_nbank_allnum'] >= 3.0   or  allcl['als_m12_id_nbank_allnum'] >= 3.0  or  allcl['als_m12_cell_nbank_else_allnum'] >= 2.0   or  allcl['als_m12_id_nbank_else_allnum'] >= 2.0   :
            dict_stratege_child['BR0061'] = 62
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0061'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['als_m12_id_max_monnum'] >= 2.0   or  allcl['als_m12_cell_max_monnum'] >= 2.0   :
            dict_stratege_child['BR0062'] = 62
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0062'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  sum([allcl['als_m1_rel_count'], allcl['als_m1_pdl_count'], allcl['als_m1_caon_count'], allcl['als_m1_caoff_count'],allcl['als_m1_coon_count'], allcl['als_m1_cooff_count'], allcl['als_m1_af_count'], allcl['als_m1_oth_count']]) >= 1.0   or \
            sum([allcl['als_m3_rel_count'], allcl['als_m1_pdl_count'], allcl['als_m3_caon_count'], allcl['als_m3_caoff_count'],allcl['als_m3_coon_count'], allcl['als_m3_cooff_count'], allcl['als_m3_af_count'], allcl['als_m3_oth_count']]) >= 2.0  :
            dict_stratege_child['BR0063'] = 62
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0063'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  ( allcl['sl_id_bank_bad'] == 0.0  and  allcl['sl_id_bank_bad_time'] <= 2.0 ) or ( allcl['sl_cell_bank_bad'] == 0.0  and  allcl['sl_cell_bank_bad_time'] <= 2.0 ) :
            dict_stratege_child['BR0064'] = 61
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0064'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['sl_id_bad_info'] == 0.0  and  allcl['sl_id_bad_info_time'] >= 3.0  :
            dict_stratege_child['BR0065'] = 60
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0065'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  ( allcl['sl_id_bank_fraud'] == 0.0  and  allcl['sl_id_bank_fraud_time'] <= 2.0 ) or ( allcl['sl_cell_bank_fraud'] == 0.0  and  allcl['sl_cell_bank_fraud_time'] <= 2.0 ) :
            dict_stratege_child['BR0066'] = 59
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0066'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  ( allcl['sl_id_bank_overdue'] == 0.0  and  allcl['sl_id_bank_overdue_time'] <= 2.0 ) or ( allcl['sl_cell_bank_overdue'] == 0.0  and  allcl['sl_cell_bank_overdue_time'] <= 2.0 ) :
            dict_stratege_child['BR0067'] = 59
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0067'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  allcl['sl_id_court_executed'] == 0.0  and  allcl['sl_id_court_executed_time'] >= 3.0  :
            dict_stratege_child['BR0068'] = 58
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0068'] = 0
            dict_strategy_group.update(dict_stratege_child)
        if  ( allcl['sl_id_bank_bad'] == 0.0  and  allcl['sl_id_bank_bad_time'] >= 3.0 ) or ( allcl['sl_cell_bank_bad'] == 0.0  and  allcl['sl_cell_bank_bad_time'] >= 3.0 ) :
            dict_stratege_child['BR0069'] = 57
            dict_strategy_group.update(dict_stratege_child)
        else:
            dict_stratege_child['BR0069'] = 0
            dict_strategy_group.update(dict_stratege_child)
        #if  :
        #    dict_stratege_child['BR0070'] = 55
        #    dict_strategy_group.update(dict_stratege_child)
        #else:
            dict_stratege_child['BR0070'] = 0
            dict_strategy_group.update(dict_stratege_child)
        ###找不到键
        # if  allcl['sl_id_court_bad'] == 0.0  and  allcl['sl_id_court_bad_time'] <= 2.0  :
        #     dict_stratege_child['BR0071'] = 55
        #     dict_strategy_group.update(dict_stratege_child)
        # else:
        #     dict_stratege_child['BR0071'] = 0
        #     dict_strategy_group.update(dict_stratege_child)
        return  dict_stratege_child,dict_strategy_group
